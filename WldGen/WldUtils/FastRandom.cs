...
namespace NeoDraw.WldGen.WldUtils { // Updated v1.4 7/25/2020
	...
	public struct FastRandom {
        ...
        public FastRandom WithModifier(int x, int y) => WithModifier((ulong)(x + 2654435769u + ((long)y << 6) + (long)((ulong)y >> 2)));
        ...
        public float NextFloat() => NextBits(24) * 5.96046448E-08f;

        public double NextDouble() => NextBits(32) * 4.656613E-10f;

        public int Next(int max) {

			if ((max & -max) == max)
				return (int)(max * (long)NextBits(31) >> 31);
        ...
        private static ulong NextSeed(ulong seed) => (seed * 25214903917L + 11) & 0xFFFFFFFFFFFFL;
